...
const defaultWsUrl = (import.meta as any).env?.VITE_WS_URL ?? 'ws://127.0.0.1:8000/ws'
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 24 }}>
      ...
      <p className="read-the-docs" style={{ marginTop: 16 }}>
        Tip: Start the FastAPI server with "python examples/api/websocket_fastapi_demo.py server" and then connect.
      </p>
    </div>
  )
}
